<h2><a href="https://leetcode.com/problems/max-increase-to-keep-city-skyline/?envType=problem-list-v2&envId=array">807. Max Increase to Keep City Skyline</a></h2><h3>Medium</h3><hr><p>There is a city composed of <code>n x n</code> blocks, where each block contains a single building shaped like a vertical square prism. You are given a <strong>0-indexed</strong> <code>n x n</code> integer matrix <code>grid</code> where <code>grid[r][c]</code> represents the <strong>height</strong> of the building located in the block at row <code>r</code> and column <code>c</code>.</p>
